...
public class CursorAdapterAB extends CursorAdapter {
	public static String TAG = CursorAdapterAB.class.getName();

	private LayoutInflater layoutInflater;

	public CursorAdapterAB(Context context, Cursor c, boolean autoRequery) {
